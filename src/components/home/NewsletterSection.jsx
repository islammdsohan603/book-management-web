  ...
  return (
    <section className="bg-[#0b0f19] py-20 px-4">
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-6xl mx-auto rounded-[32px] bg-[#2a2d37] px-6 md:px-16 py-16 text-center relative overflow-hidden"
      >
        {/* Glow Effect */}
        ...
        {/* Input + Button Form Area */}
        <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-4">
          <input
            type="email"
            placeholder="Enter your email"
            className="w-full md:w-[420px] bg-[#11151f] border border-gray-700 rounded-xl px-5 py-4 text-white outline-none focus:border-purple-500 transition-all"
          />

          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 rounded-xl bg-linear-to-r from-purple-500 to-violet-600 text-white font-semibold shadow-lg shadow-purple-500/30"
          >
            Subscribe Now
          </motion.button>
        </div>
